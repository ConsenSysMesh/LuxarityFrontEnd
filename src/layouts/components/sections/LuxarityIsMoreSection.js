        ...
        <div style={{backgroundColor: '#585A56', width: '100%', minHeight: 280, padding: '5%'}}>
          ...
          <Row style={{alignItems: 'center', justifyContent: 'center', paddingTop: '4%', flexDirection: 'space around'}}>
            <Col style={{alignItems: 'center', justifyContent:'center'}}>
              ...
              <Row style={{alignItems: 'center', justifyContent:'center'}}>
                <div style={{textAlign: 'center', color: '#D1D3D1', fontSize: 14, width: '50%', lineHeight: 1.6}}>Our network of community members donate their pre-loved luxury goods & show their support</div>
              </Row>
            </Col>
            <Col style={{alignItems: 'center', justifyContent:'center'}}>
              <Row style={{alignItems: 'center', justifyContent:'center'}}>
              ...
              <Row style={{alignItems: 'center', justifyContent:'center'}}>
                <div style={{textAlign: 'center', color: '#D1D3D1', fontSize: 14, width: '50%', lineHeight: 1.6}}>Pop-up events featuring curated pre-loved luxury goods and a transparent donation platform enabled by blockchain technology</div>
              </Row>
            </Col>
            <Col style={{alignItems: 'center', justifyContent:'center'}}>
              <Row style={{alignItems: 'center', justifyContent:'center'}}>
              ...
              <Row style={{alignItems: 'center', justifyContent:'center'}}>
                <div style={{textAlign: 'center', color: '#D1D3D1', fontSize: 14, width: '50%', lineHeight: 1.6}}>All benefits raised support projects and educational grants focusing on the United Nations Sustainable Development Goals of #12 responsible consumption, #3 health and wellbeing & #4 quality education</div>
              </Row>
            </Col>
          </Row>
        </div>
