          ...
          <Row style={{minHeight: 400, backgroundColor: '#F1F2F3'}}>
            ...
            <Col md={7} style={{alignItems: 'center', justifyContent: 'center', backgroundColor: '#595A55', padding: '8%'}}>
              <div style={{alignItems: 'center', justifyContent: 'center'}}>
                ...
                <div className="modal-text" style={{color: '#FCFCFA'}}><strong><u><a href={"https://rinkeby.etherscan.io/tx/" + this.props.transaction} target="_blank" style={{textDecoration: 'none', color: 'white'}}>Thank you for completing the R.A.W. donation journey with us.</a></u> You have just made a positive impact to help raise awareness about responsible consumption.</strong></div>
